window.onload = () => {
    ...
    class Tetromino {
        static COLORS = ["hijau", "biru", "peach", "pink", "coklat", "lilac", "ungu"];
        ...
        constructor(xs, ys, color = null) {
            ...
            if (color !== null) {
                this.color = color;
                this.img = new Image();
                this.img.src = `resources/${Tetromino.COLORS[color]}.png`
            }
        }
        ...
        collides(checkFunc) {
            for (let i = 0; i < this.length; ++i) {
                ...
                else if (FIELD[MIN_VALID_ROW - 1].some(block => block !== false)) {
                    gameover.playbackRate = 1;
                    gameover.play();
                   alert("HAHAHAHHAAH CUPU!");
                   reset();
                }
            }
            return false;
    ...
    class Skulls{
        constructor(xs, ys) {
            ...
            this.length = xs.length;
            this.img = new Image();
            this.img.src = `resources/skull.png`
        }
    ...
    let tetromino = null,
        ...
        score,
        lines,
        skullx = Math.random() * 9,
        skully = Math.floor(Math.random() * 10) + 5;
    
        var gameover = new Audio('resources/gameover.mp3');
        var audio = new Audio('resources/creep.mp3');
        var brick = new Audio('resources/brick.mp3');
